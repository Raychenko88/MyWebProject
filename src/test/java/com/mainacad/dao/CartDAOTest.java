...
class CartDAOTest {
    ...
    @Test
    void getByIdTest() {
        User user = new User("login2", "pass2", "first_name2", "last_name2");
        UserDAO.save(user);
        users.add(user);
        assertNotNull(user.getId());
        ...
        assertNotNull(savedCart.getUserId());
    }
    ...
    void getByUserAndOpenStatusTest() {
        ...
        Cart cartOk = new Cart(0, userOk.getId(), CURRENT_TIME);
        Cart cartNotOk1 = new Cart(1, userOk.getId(), CURRENT_TIME);
        Cart cartNotOk2 = new Cart(0, userNotOk.getId(), CURRENT_TIME);
    ...
    void getItemsSumGroupedByUserTest() {
        ...
        User user1 = new User("login_1", "pass0", "first_name0", "last_name0");
        User user2 = new User("login_2", "pass0", "first_name0", "last_name0");
        UserDAO.save(user1);
        UserDAO.save(user2);
        users.add(user1);
        users.add(user1);
        ...
        Cart cart1 = new Cart(1, user1.getId(), timeOk1);
        Cart cart2 = new Cart(1, user2.getId(), timeNotOk);
        Cart cart3 = new Cart(0, user1.getId(), timeOk1);
        Cart cart4 = new Cart(1, user2.getId(), timeOk1);
        Cart cart5 = new Cart(1, user2.getId(), timeOk2);
        CartDAO.save(cart1);
        CartDAO.save(cart2);
        CartDAO.save(cart3);
        CartDAO.save(cart4);
        ...
        Order order1 = new Order(item1.getId(), cart1.getId(), 1);
        Order order2 = new Order(item2.getId(), cart1.getId(), 2);
        Order order3 = new Order(item1.getId(), cart2.getId(), 3);
        Order order4 = new Order(item2.getId(), cart2.getId(), 4);
        Order order5 = new Order(item1.getId(), cart3.getId(), 5);
        Order order6 = new Order(item2.getId(), cart4.getId(), 6);
        Order order7 = new Order(item1.getId(), cart5.getId(), 7);
        Order order8 = new Order(item2.getId(), cart5.getId(), 8);
