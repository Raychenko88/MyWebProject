...
@Test
    void save() {
        User user = new User("testLogin", "testPass", "testName", "testLastName");
        UserDAO.save(user);
        users.add(user);
    ...
    @Test
    void getAll() {
        User user1 = new User("testLogin1", "testPass", "testName", "testLastName");
        User user2 = new User("testLogin2", "testPass", "testName", "testLastName");
        UserDAO.save(user1);
        UserDAO.save(user2);
        users.add(user1);
        users.add(user2);
