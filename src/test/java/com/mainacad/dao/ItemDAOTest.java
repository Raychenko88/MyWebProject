...
class ItemDAOTest {
    ...
    void getAllByUserAndPeriodTest() {
        ...
        User userOk = new User("login_item1", "pass0", "first_name0", "last_name0");
        User userNotOk = new User("login_item2", "pass0", "first_name0", "last_name0");
        UserDAO.save(userOk);
        ...
        Cart cartOk = new Cart(1, userOk.getId(), timeOk);
        Cart cartNotOk1 = new Cart(1, userNotOk.getId(), timeNotOk);
        Cart cartNotOk2 = new Cart(0, userOk.getId(), timeNotOk);
        Cart cartNotOk3 = new Cart(1, userOk.getId(), timeNotOk);
        CartDAO.save(cartOk);
        ...
        Order orderOk1 = new Order(item1.getId(), cartOk.getId(), 50);
        Order orderOk2 = new Order(item2.getId(), cartOk.getId(), 50);
        Order orderNotOk1 = new Order(item1.getId(), cartNotOk1.getId(), 50);
        Order orderNotOk2 = new Order(item2.getId(), cartNotOk2.getId(), 50);
        Order orderNotOk3 = new Order(item3.getId(), cartNotOk2.getId(), 50);
        Order orderNotOk4 = new Order(item1.getId(), cartNotOk3.getId(), 50);
